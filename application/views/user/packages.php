...
<div class="container-fluid custom_height">
  <div class="row  mt-4">
    <div class="col-md-6">
      <h1 class="fw-bolder custom-space">Membership Levels</h1>
    </div>
    ...
    <div class="col-md-8 col-12">
      <table class="table">
        ...
        <tr>
          ...
          <td> <a class="anchorstyle" href="<?php echo base_url();?>index.php/User/dashboard"><button type="button" class="btn btn-success2 fw-bold">Select</button></a></td>
        </tr>

        <tr>

          <td>Business Membership</td>
          <td>R 900 for every 6 monthsr</td>
          <!-- <td> <a class="anchorstyle" href="sign_up.html"><button type="button" class="btn btn-success2 fw-bold">Select</button></a></td> -->
        </tr>
        <tr>

          <td>Corporate Membership</td>
          <td>R 4000 for every 6 months for 5 Users</td>
          <!-- <td> <a class="anchorstyle" href="sign_up.html"><button type="button" class="btn btn-success2 fw-bold">Select</button></a></td> -->
        </tr>
